...
import type { LeadStatus, LeadSummary } from "@novoseminovo/shared-types";
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12">
      ...
      <p className="text-sm text-ink-muted">
        Toda conversa que alguém inicia com um anúncio da sua loja vira um lead aqui — mova o status
        conforme a negociação avança.
      </p>
